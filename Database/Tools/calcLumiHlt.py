    ...
    for name, runNums in datasetsInfo.items():
        ...
        if name != "DoubleMuon2016F":
            ...
            for runNum2016F in runList2016F:
                fBrilCalc = os.popen('brilcalc lumi -u /fb --normtag /cvmfs/cms-bril.cern.ch/cms-lumi-pog/Normtags/normtag_PHYSICS.json -i {} -r {} --hltpath {}'.format(lumiMaskDict[year], runNum2016F, hltDict[year]))
