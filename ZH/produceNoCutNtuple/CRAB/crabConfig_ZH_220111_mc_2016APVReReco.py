...
if __name__ == '__main__':
    ...
    config.General.requestName = 'DYJetsToLL_BGenFilter_Zpt-100to200_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_16APV_' + version
    ...
    config.JobType.pyCfgParams=['globalTag=80X_mcRun2_asymptotic_2016_TrancheIV_v8', 'isData=0', 'hltPath=HLT_Mu17_v*', 'roccorPath=ZH/Tree/data/RoccoR2016.txt']
    crabCommand('submit', config = config)

    config.General.requestName = 'DYJetsToLL_BGenFilter_Zpt-200toInf_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_16APV_' + version
    ...
    config.General.requestName = 'ZZTo2L2Q_13TeV_amcatnloFXFX_madspin_pythia8_16APV_' + version
    ...
    config.General.requestName = 'ZH_HToBB_ZToLL_M125_13TeV_powheg_pythia8_16APV_' + version
    ...
    config.General.requestName = 'ggZH_HToBB_ZToLL_M125_13TeV_powheg_pythia8_16APV_' + version
