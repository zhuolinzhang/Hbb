...
class zpeakCutflow : public edm::one::EDAnalyzer<edm::one::SharedResources> {

   public:

      explicit zpeakCutflow(const edm::ParameterSet&);
      ~zpeakCutflow();
...
//
zpeakCutflow::zpeakCutflow(const edm::ParameterSet& iConfig) {
...
void zpeakCutflow::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
...
void zpeakCutflow::beginJob() {
}

// ------------ method called once each job just after ending the event loop  ------------
void zpeakCutflow::endJob() {
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void zpeakCutflow::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(zpeakCutflow);
