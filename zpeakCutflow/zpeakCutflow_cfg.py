...
process = cms.Process("zpeakCutflow")
...
process.demo = cms.EDAnalyzer("zpeakCutflow",
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('zpeakCutflow.root'))
