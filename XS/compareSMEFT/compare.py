...
fMG5EFTcpucpBB = ROOT.TFile("./mg5XS_ZH_HToBB_ZToLL_SMEFTatNLO_cpu_cpBB.root")
fMG5EFT111 = ROOT.TFile("./mg5XS_ZH_HToBB_ZToLL_SMEFTatNLO_cpW_cpWB_cpq3i.root")
fMG5EFT222 = ROOT.TFile("./mg5XS_ZH_HToBB_ZToLL_SMEFTatNLO_cpW_cpWB_cpq3i_222.root")
hGen = fAOD.Get("qqZHGen")
...
hGen.SetTitle("")
hGen.Scale(0.100974) # hGen is xs(ZH) times BR(Hbb)
hGen.GetYaxis().SetTitle("d#sigma(ZH, Z#rightarrow l^{+}l^{-}, H#rightarrow b#bar{b}) / dp_{T} [fb/N GeV]")
...
hRatioMulti.GetXaxis().SetLimits(0, 600)
hRatioMulti.GetXaxis().SetTitle("p_{T}(H) [GeV]")
hRatioMulti.GetYaxis().SetNdivisions(505)
hRatioMulti.GetYaxis().SetRangeUser(0.7, 2.3)
...
upperPad.cd()
leg = ROOT.TLegend(0.13, 0.05, 0.35, 0.49)
