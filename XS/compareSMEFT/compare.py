...
hRatiocpucpBB.SetMarkerStyle(22)
...
hRatiocpWcpWBcpq3i.SetMarkerStyle(34)
...
hRatiocpWcpWBcpq3i222.SetMarkerStyle(47)
...
upperPad.cd()
leg = ROOT.TLegend(0.15, 0.05, 0.45, 0.6)
