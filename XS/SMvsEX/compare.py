...
hRatio.GetYaxis().SetTitle("#frac{powheg+pythia}{madgraph+pythia}")
...
upperPad.cd()
leg = ROOT.TLegend(0.5, 0.55, 0.86, 0.87)
leg.SetBorderSize(0)
leg.AddEntry(hGen, "MadGraph5@NLO + Pythia8", "PE")
leg.AddEntry(hReco, "powhegV2 + Pythia8(MINIAOD)", "PE")
